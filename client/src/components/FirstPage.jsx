...
function FirstPage() {
  ...
  return (
    ...
    <div className='p-5 first-child-transparent overflow-hidden px-2 py-5 flex flex-col gap-10 justify-center items-center '>


<div className="w-screen   lg:h-[70vh] md:h-[80vh] h-[60vh] ">
  <img
    className="w-full -z-50  h-full object-contain"
    src={first}
    alt="first_Img"
  />
</div>
...
<div className="w-screen h-fit px-10 flex flex-col md:flex-row ">
  {/* Image Section */}
...
<div className=''>
  <h1 className='text-3xl my-5 font-bold'> Products</h1>
...
<div className="flex flex-col  md:flex-row w-full h-fit items-center p-4">
  ...
  {/* Text Section */}
  <div className="w-full md:w-[50%] bg-gray-100 flex flex-col  p-4">
    <div>
